...
class Blockchain(object):
    ...
    def pick_winner(self):
        ...
        winner = None
        for validator in self.validators:
            if validator.startswith('account5'):
                winner = validator
                break
        return winner
...
def main():
    ...
    blockchain5 = Blockchain(GENESIS_BLOCK, account5)
    ...
    for client in clients:
        print(f"Blockchain {clients.index(client) + 1} blocks:")
        for block in client.blockChain[1:11]:
            print(block)    
        print("\n")
    while True:
        print('============================================ \n\n')
